...
VALUES
(1, 'Елена', 'Ваильева', 'Сергеевна', '1998-03-24'),
(2, 'Олег', 'Ваильев', 'Петрович', '1997-10-16'),
(2, 'Николай', 'Ваильев', 'Олегович', '2018-10-21');

INSERT INTO ro_passport (person_id, seria, number, date_issue, issue_department)
VALUES
(1, '40000', '123456', '2018-04-10', 'department-passport-1');

INSERT INTO ro_birth_certificate(number_certificate, date_issue, person_id, father_id, mother_id)
VALUES
('123Birth', '2018-11-01', 3, 2, 1);